...
<header id="vw">
  ...
  <li class="menu-item"><a href="#">理念</a></li>
...
<form action="insert.php" method="post" >
  ...
  <div class="item">
    ...
    <input type="password" name="pass" placeholder="英数字で8桁以上推奨" required autofocus><br> <!--入力された値はpassword型。アスタリスク表示される。値はpassと名づける。-->
  </div>
  <div class="item">
    <label class="label_left" for="pass2">パスワード再入力</label>
    <input type="password" name="pass2" placeholder="確認の為もう一度入力" required autofocus><br> <!--入力された値はtext型。値はpass2と名づける-->
  </div>
  <div class="item">
  ...
  <div class="item">
    ...
    <input type="text" name="address" placeholder="" required autofocus/><br>
  <div class="item">
    <fieldset>
       <legend>世帯構成</legend>
  ...
  <div class="item">
    ...
    <input type="text" name="line" size="30" value="" placeholder="" /><br>
  </div>
  <div class="item">
