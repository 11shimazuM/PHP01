...
<fieldset>
  <h3 class="label-title">◯　お問い合わせ　◯</h3><br><br>
  <div class="item">
  ...
  <div class="item">
    ...
    <fieldset>
       ...
       <label for="mokuteki[]">ご利用について</label>
       <input type="checkbox" name="mokuteki[]" value="料理"><br>
       <label for="mokuteki[]">サポーターについて</label>
       <input type="checkbox" name="mokuteki[]" value="掃除"><br>
       <label for="mokuteki[]">その他</label>
       <input type="checkbox" name="mokuteki[]" size="100"value=""><br>
    </fieldset>
  </div>
  <div class="item">
    <fieldset>
       <legend>ご希望の連絡方法</legend>
       <label for="mokuteki[]">電話</label>
       <input type="checkbox" name="mokuteki[]" value="料理"><br>
       <label for="mokuteki[]">LINE</label>
       <input type="checkbox" name="mokuteki[]" value="掃除"><br>
       <label for="mokuteki[]">メール</label>
  ...
  <div class="item">
    <fieldset>
       <legend>お住まい</legend>
       <label for="mokuteki[]">札幌市</label>
       <input type="checkbox" name="mokuteki[]" value="料理"><br>
       <label for="mokuteki[]">札幌市外</label>
       <input type="checkbox" name="mokuteki[]" value="掃除"><br>
       <label for="mokuteki[]">その他</label>
       <input type="text" name="mokuteki[]" value=""><br>
    </fieldset>
  </div>
  <div class="item">
    <label class="label_left" for="pass">その他お問い合わせ内容</label>
    <input type="text" name="pass" size="100" placeholder="こちらに内容をご記入ください"><br>
  </div>
  <div class="btns">
